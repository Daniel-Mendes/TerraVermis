...
public class FishingHookWithBaitRenderer extends EntityRenderer<FishingHookWithBait, FishingHookRenderState> {
    private static final ResourceLocation TEXTURE_LOCATION = Constants.id("textures/entity/fishing_hook_with_bait.png");
    ...
    public boolean shouldRender(FishingHookWithBait p_363069_, Frustum p_362635_, double p_361840_, double p_361502_, double p_360380_) {
    ...
    public void render(FishingHookRenderState p_362456_, PoseStack p_114699_, MultiBufferSource p_114700_, int p_114701_) {
        p_114699_.pushPose();
        p_114699_.pushPose();
        p_114699_.scale(0.75F, 0.75F, 0.75F);
    ...
    public static HumanoidArm getHoldingArm(Player player) {
        return player.getMainHandItem().getItem() instanceof FishingRodWithBaitItem ? player.getMainArm() : player.getMainArm().getOpposite();
    }
    ...
    public void extractRenderState(FishingHookWithBait p_361584_, FishingHookRenderState p_364824_, float p_360891_) {
    ...
    protected boolean affectedByCulling(FishingHookWithBait p_365042_) {
        return false;
    }
}
